...
public class RestBankOperationData {
    ...
    public RestBankOperationData(String sourceIban, String targerIban, long value, String transactionSource, String transactionReference) {
        this.sourceIban = sourceIban;
        this.targetIban = targerIban;
        this.value = value;
